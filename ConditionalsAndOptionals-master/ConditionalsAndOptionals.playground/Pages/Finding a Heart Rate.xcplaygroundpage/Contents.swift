/*:
 ...
 Many code libraries that give you information gathered by the hardware return optionals. For example, a library for working with a heart rate monitor may give you `nil` if the heart rate monitor is adjusted poorly and cannot properly read the user's heart rate.
...
if let unwrappedHeartRate: Int? = heartRate {
    print(unwrappedHeartRate)
}  else {
    print("There is no value")
}

let totalHRate = oldHR1 + oldHR2 + oldHR3 + oldHR4 + 74

let hrAverage = totalHRate / 5
print(hrAverage)
